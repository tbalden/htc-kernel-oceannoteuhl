...
enum HTC_ADM_EFFECT_ID {
	...
	HTC_ADM_EFFECT_AS_DATA1,
	HTC_ADM_EFFECT_AS_DATA2,
	HTC_ADM_EFFECT_AS_DATA3,
	HTC_ADM_EFFECT_AS_DATA4,
	HTC_ADM_EFFECT_AS_DATA5,
	HTC_ADM_EFFECT_AS_DATA6,
	HTC_ADM_EFFECT_AS_DATA7,
#endif
	HTC_ADM_EFFECT_MAX,
};
...
int htc_adm_effect_control(enum HTC_ADM_EFFECT_ID effect_id, u16 port_id,
				uint32_t copp_id, uint32_t payload_size,
				void *payload);
