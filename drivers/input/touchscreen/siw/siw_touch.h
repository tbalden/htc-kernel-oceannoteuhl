...
enum {
	...
	CONNECT_STANDARD_HOST,		
	CONNECT_CHARGING_HOST,
	CONNECT_NONSTANDARD_CHARGER,	
	CONNECT_STANDARD_CHARGER,	
	CONNECT_APPLE_2_1A_CHARGER,	
	CONNECT_APPLE_1_0A_CHARGER,	
	CONNECT_APPLE_0_5A_CHARGER,	
...
struct touch_feature_ctrl {
	...
	bool tp_bus_sel_en;
	bool bus_to_mcu;
#define SWITCH_DELAY_TIME_MAX 50	
