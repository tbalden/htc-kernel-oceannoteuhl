...
struct siw_hal_swipe_ctrl {
	u32 mode;
	struct siw_hal_swipe_info info[2]; 
};
...
#define DISTANCE_INTER_TAP			__SIZE_POW(1) 
#define DISTANCE_TOUCHSLOP			__SIZE_POW(2)	
#define TIMEOUT_INTER_TAP_LONG		__SIZE_POW(3)	
#define MULTI_FINGER				__SIZE_POW(4)	
#define DELAY_TIME					__SIZE_POW(5)	
#define TIMEOUT_INTER_TAP_SHORT		__SIZE_POW(6)	
#define PALM_STATE					__SIZE_POW(7)	
#define TAP_TIMEOVER				__SIZE_POW(8)	
