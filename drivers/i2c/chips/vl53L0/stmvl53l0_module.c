...
#define LONG_DISTANCE_SIGNAL_RATE_LIMIT         (65536 / 10) 
...
#define HIGH_ACCURACY_SIGNAL_RATE_LIMIT         (25 * 65536 / 100) 
...
#if 0
static DEVICE_ATTR(enable_debug, 0660,
...
#if 0
static DEVICE_ATTR(enable_timing_debug, 0660,
...
#if 0
static DEVICE_ATTR(set_delay_ms, 0660,
...
static DEVICE_ATTR(set_timing_budget, 0660,
...
#if 0
static DEVICE_ATTR(set_use_case, 0660,
...
#if 0
static DEVICE_ATTR(show_current_configuration, 0660,
...
#if 0
static DEVICE_ATTR(do_flush, 0660,
        NULL,
        stmvl53l0_do_flush);
            ...
            switch (parameter.name) {
                ...
                case (XTALKRATE_PAR):
                    ...
                    papi_func_tbl->GetXTalkCompensationRateMegaCps(
                        ...
                        if (data->XTalkCompensationRateMegaCps < 7*65536/10000) { 
...
static int stmvl53l0_init_client(struct stmvl53l0_data *data)
{
    ...
    if (Status == VL53L0_ERROR_NONE && data->reset) {
        if (data->xtalk_kvalue != 0) { 
            ...
            if (vl53l0_dev->xtalk_kvalue < 7*65536/10000) { 
                ritValue = 15 * 7 * 65536/100000;
            } else {
