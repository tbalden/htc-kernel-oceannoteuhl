...
static int temp_right[MAX_ID][HEALTH_LEVELS] = {
          {       20,    70,   120,  420,   450,   480,   550, INT_MAX},
          {       20,    70,   170,  420,   450,   480,   550, INT_MAX}
};

static int  temp_left[MAX_ID][HEALTH_LEVELS] = {
          { -INT_MAX,    -1,    49,   99,   400,   430,   460, 530},
          { -INT_MAX,    -1,    49,  149,   400,   430,   460, 530}
};

static int ibat_map[MAX_IDX][HEALTH_LEVELS] = {
 {        0,  2100,  2100, 2900,  2100,  1500,  1500, 0},
 {        0,  2100,  2100, 2900,  1000,  1000,  1000, 0},
 {        0,   900,   900, 1500,  1500,  1500,     0, 0},
 {        0,   900,   900, 1500,  1000,  1000,     0, 0},
 {        0,  2100,  2100, 2900,  2100,  1500,  1500, 0},
 {        0,  2100,  2100, 2900,  1500,  1500,  1500, 0},
 {        0,   900,   900, 1500,  1500,  1500,     0, 0},
 {        0,   900,   900, 1500,  1500,  1500,     0, 0},
 {        0,  1500,  1500, 2900,  2100,  1500,  1500, 0},
 {        0,  1500,  1500, 2900,  1000,  1000,  1000, 0},
 {        0,   300,   600, 2100,  2100,  1500,     0, 0},
 {        0,   300,   600, 2100,  1000,  1000,     0, 0},
 {        0,  1500,  1500, 2900,  2100,  1500,  1500, 0},
 {        0,  1500,  1500, 2900,  1500,  1500,  1500, 0},
 {        0,   300,   600, 2100,  2100,  1500,     0, 0},
 {        0,   300,   600, 2100,  1500,  1500,     0, 0}
};
