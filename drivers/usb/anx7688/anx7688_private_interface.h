...
#define VBUS_DELAY_TIME 0x22
#define TRY_UFP_TIMER 0x23

#define AUTO_PD_MODE 0x27
#define AUTO_PD_ENABLE 0x02
#define TRY_SNK_ENABLE BIT_IN_BYTE(3)

#define MAX_VOLTAGE_SETTING 0x1B
#define MAX_POWER_SETTING 0x1C
#define MIN_POWER_SETTING 0x1D
